...
extern __code uint8_t number_t[];
extern __code uint8_t number_i[];
extern __code uint8_t number_m[];
extern __code uint8_t number_u[];
extern __code uint8_t number_p[];
