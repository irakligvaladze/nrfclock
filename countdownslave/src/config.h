...
// Pin definitions
#define PIN_CSN             P11       // NRF SPI slave select pin
...
#define PIN_BUZZER          P30       // pin connected to builtin LED
#define PIN_IRQ             P33       // NRF interrupt pin
#define PIN_CE              P32       // NRF cable enable pin
#define PIN_LED             P31       // LED pin    


#define PIN_DISP_CS         P34       // Display spi CS line
...
#define HELP_IDENT          '?'       // help command
...
#define MANUFACTURER_STR    'D','I','G','I','T','I','Z','E'
